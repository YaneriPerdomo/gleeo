...
<body class="flex-and-direction-column height-full">
    ...
    <main class="flex-grow-2 w-100 flex-and-direction-column flex-center-full flex-center-full-start">
        <article class="row main__article container-xl w-100">
            ...
            <x-tutor-configuration-content description-parameters="Contenido de Esfuerzo"
                class="initial-decision-patterns" title="Contenido de Esfuerzo" url="initial-decision-patterns.edit"
                :urls-beginning-end="[
                    [
                        'title' => 'Configuración del Tutor > ',
                        'url' => 'alert-thresholds.index',
                    ],
                    ['title' => 'Contenido de Esfuerzo', 'url' => 'alert-thresholds.index'],
                ]"
                paragraph="Este módulo permite configurar el apoyo del tutor inteligente. Su función es
                proporcionar material de refuerzo de manera automática si el usuario en la plataforma educativa
                supera un número específico de errores durante una lección."
                :parameters="[
                    [
