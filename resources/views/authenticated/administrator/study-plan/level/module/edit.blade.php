            ...
            <div class="col-lg-10 col-12 main__content bg-white-border">
                ...
                <form
                    ...
                    <legend class="form__title">
                        <b> Editar Información del Módulo</b>
                    </legend>
                    ...
                    <x-input-text :item="[
                        ...
                        'form_input_value_default' => old('module_title', $module->title),
                        'attribute_a' => 'required',
                        'form_help_text' => 'Este es el título principal que verán los alumnos.',
                    ]"></x-input-text>
