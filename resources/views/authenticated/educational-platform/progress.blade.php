                        ...
                        <div class="you-progress__pointer-statistics pointer-statistics flex-and-direction-row flex-content-space-between"
                            ...
                            <div
                                ...
                                <div class="circle-ring"
                                    ...
                                    <div class="circle-inner">
                                        <span class="pointer-statistics__item-title">Éxito</span>
                                        <span
                            ...
                            <div
                                ...
                                <div class="circle-ring"
                                    ...
                                    <div class="circle-inner">
                                        <span
                                            class="pointer-statistics__item-title">{{ $mistakesMade <= 1 ? 'Error' : 'Errores' }}</span>
                            ...
                            <div
                                ...
                                <div class="circle-ring" style="--clr:var(--green); --percent: 100;">
                                    <div class="circle-inner">
                                        <span
                                            class="pointer-statistics__item-title">{{ $pointsObtained <= 1 ? 'Punto' : 'Puntos' }}</span>
